...
public class SimpleSongs extends Activity {
	...
	public static int TIME2 = 40;
	public static int TIME3 = 60;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for( int i = 0; i < 4; i++ )
        {
        	...
        	switch( i )
        	{
        	case 0: ms.getButtons( this, R.id.folder1 ); break;
        	case 1: ms.getButtons( this, R.id.folder2 ); break;
        	case 2: ms.getButtons( this, R.id.folder3 ); break;
        	case 3: ms.getButtons( this, R.id.folder4 ); break;
        	}
        	ms.makeDirs();
        	folders.add( ms );
        }
    ...
    public class MusicSet implements OnClickListener, OnCompletionListener
    {
		...
		public void onClick( View v )
		{
			...
			button.setText( "Time: " + timesClicked*20 + " minutes" );
